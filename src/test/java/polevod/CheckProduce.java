...
public class CheckProduce {
    ...
    By byCards = new By.ByXPath(".//div[@class=\"ExpandedRowItem_ProtectionWrapper_210X_\"]/div");
    ...
    void testFirst() throws InterruptedException {
        ...
        try {
            ...
            for (int threatCardIndex = 0; threatCardIndex < threadCardList.size(); threatCardIndex++) {
                ...
                if (threadCard.findElements(new By.ByXPath(".//div[@class=\"ExpandedRowItem_ProtectionWrapper_210X_\"]/div[@class=\"ExpandedRowItem_ProtectionsPlaceholder_nUvki\"]")).size()>0) {
                    continue;
                }

                boolean end = false;
                while (end == false) {
                    wait.until(ExpectedConditions.visibilityOfElementLocated(new By.ByXPath(".//div[@class=\"ExpandedRowItem_ProtectionWrapper_210X_\"]")));
