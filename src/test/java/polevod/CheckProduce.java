...
public class CheckProduce {
    ...
    By byCards = new By.ByXPath("(//div[contains(.,\"Снежная плесень\")])[last()]/../../..//div[@class=\"ExpandedRowItem_ProtectionWrapper_210X_\"]/div");

    By byLoadNext = new By.ByXPath("(//div[contains(.,\"Снежная плесень\")])[last()]/../../..//span[contains(text(), \"Загрузить еще\")]/..");
